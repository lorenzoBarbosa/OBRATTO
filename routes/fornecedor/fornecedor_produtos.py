...
async def listar_produtos(request: Request):
    ...
    response = templates.TemplateResponse("fornecedor/produtos.html", {"request": request, "produtos": produtos})
    return response

@router.get("/fornecedor/produtos/inserir")
async def mostrar_formulario_produto(request: Request):
    response = templates.TemplateResponse("fornecedor/cadastrar_produtos.html", {"request": request})
    return response
...
async def cadastrar_produto(request: Request, nome: str = Form(...), descricao: str = Form(...), preco: float = Form(...), quantidade: int = Form(...)):
    ...
    produtos = produto_repo.obter_produto_por_pagina(limit=10, offset=0)
    response = templates.TemplateResponse("fornecedor/produtos.html", {"request": request, "produtos": produtos, "mensagem": "Produto inserido com sucesso"})
    return response
...
async def mostrar_formulario_atualizar_produto(request: Request, id: int):
    ...
    if produto:
        response = templates.TemplateResponse("fornecedor/alterar_produtos.html", {"request": request, "produto": produto})
    else:
        produtos = produto_repo.obter_produto_por_pagina(limit=10, offset=0)
        response = templates.TemplateResponse("fornecedor/produtos.html", {"request": request, "produtos": produtos, "mensagem": "Produto não encontrado"})
    return response
...
async def atualizar_produto(request: Request, id: int, nome: str = Form(...), descricao: str = Form(...), preco: float = Form(...), quantidade: int = Form(...)):
    ...
    produtos = produto_repo.obter_produto_por_pagina(limit=10, offset=0)
    response = templates.TemplateResponse("fornecedor/produtos.html", {"request": request, "produtos": produtos, "mensagem": "Produto atualizado com sucesso"})
    return response
...
async def excluir_produto(request: Request, id: int):
    ...
    if produto:
        ...
        produtos = produto_repo.obter_produto_por_pagina(limit=10, offset=0)
        response = templates.TemplateResponse("fornecedor/produtos.html", {"request": request, "produtos": produtos, "mensagem": "Produto excluído com sucesso"})
    else:
        produtos = produto_repo.obter_produto_por_pagina(limit=10, offset=0)
        response = templates.TemplateResponse("fornecedor/produtos.html", {"request": request, "produtos": produtos, "mensagem": "Produto não encontrado"})
    return response
