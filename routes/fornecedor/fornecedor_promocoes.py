...
async def cadastrar_promocao(request: Request):
    return templates.TemplateResponse("fornecedor/cadastrar_promocoes.html", {"request": request})

# Rota para alterar promoção
@router.get("/fornecedor/promocoes/alterar")
async def alterar_promocao(request: Request):
    return templates.TemplateResponse("fornecedor/alterar_promocoes.html", {"request": request})

# Rota para listar todas promoções
@router.get("/fornecedor/promocoes")
async def listar_promocoes(request: Request):
    return templates.TemplateResponse("fornecedor/promocoes.html", {"request": request})
...
async def confirmar_exclusao_promocao(request: Request):
    return templates.TemplateResponse("fornecedor/confirmar_exclusao_promocao.html", {"request": request})
